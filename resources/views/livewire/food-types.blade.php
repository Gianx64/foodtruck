	...
	<div class="card-header">
		<div style="display: flex; justify-content: space-between; align-items: center;">
			<div class="float-left">
				<h4><i class="fab fa-laravel text-info"></i>Food Type Names Listing</h4>
			</div>
			...
			<div>
				<input wire:model='keyWord' type="text" class="form-control" name="search" id="search" placeholder="Search food type name">
			</div>
		</div>
	</div>
	<div class="card-body">
			...
			<table class="table table-bordered table-sm">
				...
				<tbody>
					...
					<tr>
						...
						<td width="100">
							<button type="button" onclick="confirm('Confirm delete food type {{$row->name}}? \nDeleted food types cannot be recovered!')||event.stopImmediatePropagation()"
