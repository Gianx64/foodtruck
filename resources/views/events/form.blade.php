...
<div class="row">
	...
	<div class="col-md-6">
		...
		<textarea cols=50 type="text" id="description" name="description" value="{{ $event->description ?? old('description') }}" placeholder="Event description (extra details, warnings, links, etc.)" required>
		</textarea>
		@error('description')
			<span class="invalid-feedback" role="alert">
				<strong>{{ $message }}</strong>
